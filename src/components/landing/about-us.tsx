...
export function AboutUs() {
  return (
    <section className="flex w-full flex-col items-center bg-[#152959]">
      <div className="container flex flex-col overflow-hidden px-4 xl:my-0 xl:flex-row">
        ...
        <div className="text-primary-foreground order-2 mb-10 flex items-center xl:order-2 xl:my-0 xl:mb-0 xl:ml-10">
          <div>
