...
import type { AttributeValueCount } from "@/app/dashboard/events/[id]/statistics/aggregate";
import {
  ChartContainer,
  ChartTooltip,
  ChartTooltipContent,
      ...
      >
        <PieChart>
          ...
          <Pie data={slices} dataKey="count" nameKey="key">
            {/* recharts types `content`'s viewBox as the cartesian|polar union;
                on a Pie it is always the polar shape SliceLabelProps expects. */}
            <LabelList
              content={
