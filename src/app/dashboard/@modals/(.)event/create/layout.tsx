...
export default function CreateEventFormLayout({
  ...
  return (
    <div className="absolute left-0 top-0 z-40 flex min-h-screen w-full flex-col items-center justify-center bg-black/75">
      <div className="flex w-full max-w-3xl flex-col items-end rounded-xl bg-white p-6">
        <Link
          href="/dashboard"
